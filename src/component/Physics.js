...
function Physics() {
  ...
  /******************************** Show *******************************************************/
  const show = () => {
    const baseURL = 'https://prince9559.github.io/jsonproject/physics.json';
  ...
  return (
    <div>
      {showFirework && (
        <div className="firewo-containers">
          {[...Array(20)].map((_, i) => (
            <div
              key={i}
              className="fire-spa"
  ...
  <div className="we">
    ...
    <button className="q" onClick={show}>
      <b>Restart Quiz</b>
    </button>
  </div>
)}
      ...
      {questions.length > 0 && (
        <div>
          ...
          <h1 className="ff">🥀 <i>Welcome to Computer Quiz</i> 🌷</h1>

          <h2 className="qq"><b>Question No:</b> {questions[qno]["ques_no"]}</h2>
          <h2 className="n"><b>Question:</b> {questions[qno]["question"]}</h2>
          <h2>✅ Your Score: {score} / {questions.length}</h2>

          <div className="radio-contai">
            <div className="radio-but">
              ...
              <button className="t" onClick={() => { handleNext(); storeData(); }}>Next</button>
          ...
          <a className="what-buttons" href="https://wa.me/919559618602" target="_blank" rel="noreferrer">
          ...
          <a className="link-buttons" href="https://www.linkedin.com/in/prince-kumar-724160333/" target="_blank" rel="noreferrer">
          ...
          <a className="git-buttons" href="https://github.com/prince9559" target="_blank" rel="noreferrer">
